...
sudo wget -O ${INSTALL_FOLDER}/modesmixer2_debian9_x86_64_20190413.tgz "https://drive.google.com/uc?export=download&id=1RHGpQPmZgOrPEvhKNiADZqfmOQxmDZXN"

echo "Unzipping downloaded file"
sudo tar xvzf ${INSTALL_FOLDER}/modesmixer2_debian9_x86_64_20190413.tgz -C ${INSTALL_FOLDER}
